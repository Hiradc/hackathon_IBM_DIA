...
$$
\text{Empreinte carbone de la requête} =
\text{Énergie consommée par la requête} \times 
\text{Empreinte carbone d'un kWh} +
\frac{\text{Empreinte carbone de l'entraînement du modèle}}{\text{Nombre moyen de requêtes}}
$$
