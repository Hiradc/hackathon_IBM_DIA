# python -u "c:\Users\nicol\Documents\ESILV\S9\BI Pipeline\app\app.py"
...
# ✂️ Fonctions de la bibliothèque NLTK (Natural Language Toolkit)
# sent_tokenize : découpe un texte en phrases
# word_tokenize : découpe un texte en mots
# Ces outils permettent d’effectuer des analyses plus fines sur les réponses générées
...
def request_llm_co2_consumption(question, id_modele):
    ...
    # ✂️ Découpage du texte en phrases et en mots avec NLTK
    ...
    nom_fichier = f"./output/resultats_llm_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    ...
    modele = joblib.load("random_forest.pkl")
